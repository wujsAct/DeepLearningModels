  ...
  def __init__(self,filters,word_embedding_size,num_filters):
    ...
    for i,filter_size in enumerate(self.filters):
      with tf.name_scope("conv-maxpool-%s" % filter_size):
        ...
        self.Ws.append(tf.Variable(tf.truncated_normal(filter_shape, stddev=0.1), name="Weight"))
        self.bs.append(tf.Variable(tf.constant(0.1, shape=[self.num_filters]), name="bias"))
  '''
