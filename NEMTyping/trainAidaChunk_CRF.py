...
#  train_batch_size = args.batch_size;
  ...
  if model.load(sess,args.restore,"conll2000"):
    ...
    print "[*] There is no checkpoint for conll2000"
  ...
  for e in range(args.epoch):
    ...
    for ptr in xrange(0,len(train_input),args.batch_size):
      ...
      if m > maximum:
        ...
        maximum = m
        print "------------------"
        print("test: loss:%.4f accuracy:%f chunk :%.2f,B-NP:%.2f I-NP:%.2f B-VP:%.2f I-VP:%.2f" %(loss1,accuracy,100*fscore[5],100*fscore[1],100*fscore[3],100*fscore[2],100*fscore[0]))
        print "------------------"
      ...
      if id_epoch %10==0:
        print("train: loss:%.4f accuracy:%f chunk :%.2f,B-NP:%.2f I-NP:%.2f B-VP:%.2f I-VP:%.2f" %(loss1,accuracy,100*fscore[5],100*fscore[1],100*fscore[3],100*fscore[2],100*fscore[0]))
#  except:
