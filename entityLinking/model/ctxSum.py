...
class ctxSum(object):
  ...
  def __init__(self,args):
    ...
    self.prediction_prob = tf.scan(lambda a,x: tf.matmul(x,self.w_prob)+self.bias_prob,self.candidate_ent_prob_feature,initializer=tf.Variable(tf.random_normal((args.candidate_ent_num,1))))[:,:,0]
