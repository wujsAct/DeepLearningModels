...
def main(_):
  ...
  testa_ent_surfacewordv_feature = testaUtils.ent_surfacewordv_feature  
  ...
  testb_ent_surfacewordv_feature = testbUtils.ent_surfacewordv_feature 
    ...
    for e in range(100):
      ...
      for ptr in xrange(0,len(train_input),args.batch_size):
        ...
        ent_mention_linking_tag_list,candidate_ent_linking_feature,candidate_ent_type_feature,candidate_ent_prob_feature,ent_mention_lstm_feature,candidate_ent_relcoherent_feature,ent_surfacewordv_feature = \
                                                  ...
                                                  train_ent_relcoherent,train_ent_mention_link_feature,train_ent_linking_type,train_ent_linking_candprob,train_ent_surfacewordv_feature,ptr,flag='train')
...
#          modelNEL.save(sess,args.restore,"aida")
        ...
        if id_epoch%20==0:
          ent_mention_linking_tag_list,candidate_ent_linking_feature,candidate_ent_type_feature,candidate_ent_prob_feature,ent_mention_lstm_feature,candidate_ent_relcoherent_feature,ent_surfacewordv_feature = \
                                                  ...
                                                  testa_ent_relcoherent,testa_ent_mention_link_feature,testa_ent_linking_type,testa_ent_linking_candprob,testa_ent_surfacewordv_feature,0,flag='testa')
          loss2,accuracy,pred = sess.run([loss_linking,modelNEL.accuracy,modelNEL.prediction],
                                 {modelNEL.ent_mention_linking_tag:ent_mention_linking_tag_list,
                                  ...
                                  modelNEL.candidate_ent_type_feature:candidate_ent_type_feature,
                                  modelNEL.candidate_ent_prob_feature:candidate_ent_prob_feature,
                                  modelNEL.ent_mention_lstm_feature:ent_mention_lstm_feature, modelNEL.ent_surfacewordv_feature:ent_surfacewordv_feature
                                 })
          ...
          ent_mention_linking_tag_list,candidate_ent_linking_feature,candidate_ent_type_feature,candidate_ent_prob_feature,ent_mention_lstm_feature,candidate_ent_relcoherent_feature,ent_surfacewordv_feature=\
                                                ...
                                                testb_ent_relcoherent,testb_ent_mention_link_feature,testb_ent_linking_type,testb_ent_linking_candprob,testb_ent_surfacewordv_feature,0,flag='testb')
          loss2,accuracy,pred = sess.run([loss_linking,modelNEL.accuracy,modelNEL.prediction],
                               {modelNEL.ent_mention_linking_tag:ent_mention_linking_tag_list,
                                modelNEL.candidate_ent_coherent_feature:candidate_ent_relcoherent_feature,
                                modelNEL.candidate_ent_linking_feature:candidate_ent_linking_feature,
...
#      if average_linking_accuracy_train > maximum_linking:
#        maximum_linking = average_linking_accuracy_train
#        modelNEL.save(sess,args.restore,"aida")
